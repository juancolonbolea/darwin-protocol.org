---
title: "Theorems"
description: "70 active theorems (61 positive + 9 failure), derived from the primitives and axioms and conditional on P6."
---

## What a theorem is here

Every theorem in this section is *derived*, not posited. Each one traces, through an explicit dependency chain, back to the seven primitives and thirteen axioms — nothing hangs unsupported. Where an entry says "Derives from," that is a real proof obligation, not a citation: given the axioms and prior theorems listed, the theorem's conclusion follows.
...
| Failure Theorems + Named Principles | F1–F9 | [Failure Theorems](/specification/theorems/failure) |

**Total: 70 active theorems — 61 positive + 9 failure.** (T4 is absorbed into T11 and does not count separately; T62 and T63 are not part of the active set.) Twenty-one formal proofs exist; six are published as standalone [proof pages](/specification/proofs), and the rest are referenced inline as "Proof N in the constitution."

## Dependency graph

At the group level, dependency runs one direction — down from primitives and axioms, forward through the theorem groups — with the failure theorems drawing on the same axioms and later theorems from the opposite side (negated).

```mermaid
flowchart TD
    P["7 Primitives — P0 Information Asymmetry ... P6 Merit"]
    AX["13 Axioms — A1-A16 (existential, structural, architectural)"]
